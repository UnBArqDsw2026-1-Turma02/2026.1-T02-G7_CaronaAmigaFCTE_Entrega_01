...
O Diagrama de Causa e Efeito, também conhecido como Diagrama de Ishikawa ou Espinha de Peixe, é uma ferramenta da qualidade utilizada para identificar, organizar e analisar as possíveis causas de um problema específico.

Criado por Kaoru Ishikawa, esse método permite estruturar visualmente as relações entre um problema central e suas causas, agrupando-as em categorias. Dessa forma, facilita a compreensão do problema de maneira sistêmica e apoia a tomada de decisão na busca por soluções mais eficazes.
...
**Problema Principal**: Falta de uma plataforma eficiente para conectar alunos que oferecem e precisam de carona.
