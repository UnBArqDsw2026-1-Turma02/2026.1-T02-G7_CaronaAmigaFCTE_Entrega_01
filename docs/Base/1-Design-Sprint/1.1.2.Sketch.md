...
Como resultado, o [Glossário](/Base/2-Artefato-Generalista/2.1.2.Glossario.md) complementa o [Léxico](/Base/2-Artefato-Generalista/Lexico.md), reforçando a comunicação entre os membros da equipe e apoiando decisões de modelagem e de requisitos na fase **[Decision](/Base/1-Design-Sprint/1.1.3.Decision.md)**.
</details>
