...
Ao longo do Design Sprint, o processo é dividido em etapas bem definidas, que incluem a compreensão do problema [(_Unpack_)](Base/1-Design-Sprint/unpack.md), a geração de ideias [(_Sketch_)](Base/1-Design-Sprint/1.1.2.Sketch.md), a tomada de decisão [(_Decision_)](Base/1-Design-Sprint/1.1.3.Decision.md), a prototipação [(_Prototype_)](Base/1-Design-Sprint/prototype.md) e a validação [(_Test_)](Base/1-Design-Sprint/test.md). Cada uma dessas fases possui um papel fundamental na construção de soluções centradas no usuário.
...
|      [Pedro Henrique Faria da Mota](https://github.com/PhFariaa)      | Apoio na consolidação da validação | 02/04/2026 | 21:00 | Microsoft Teams |
...
[Luiza da Silva Pugas](https://github.com/Luizaxx),
[Nicolas Bomfim Dias Bandeira](https://github.com/NickGehjk),
[Pedro Henrique Faria da Mota](https://github.com/PhFariaa),
[Wanjo Christopher Paraizo Escobar](https://github.com/wChrstphr), 2026)
...
Abaixo, na figura 4 se encontra o Storyboard:
...
A etapa de _Decision_ desempenhou um papel fundamental na consolidação das ideias geradas ao longo do Design Sprint, permitindo a convergência de diferentes perspectivas em uma solução coesa, estruturada e centrada no usuário. Por meio da utilização integrada do Rich Picture e dos Storyboards, foi possível transformar abstrações iniciais em representações visuais claras, facilitando a compreensão do sistema e o alinhamento entre os membros da equipe.

A validação realizada evidenciou que os artefatos produzidos atendem aos objetivos propostos, apresentando clareza, coerência e aderência à realidade dos usuários, além de contribuírem para a identificação de ajustes e oportunidades de melhoria antes da etapa de prototipação. A divisão dos storyboards em duas perspectivas — passageiro e motorista — mostrou-se especialmente relevante, ao garantir maior fidelidade às diferentes jornadas de uso e evitar ambiguidades na interpretação dos fluxos.

Dessa forma, a etapa de decisão não apenas definiu o direcionamento da solução, mas também reduziu incertezas e fortaleceu a base conceitual do projeto. Os artefatos consolidados servirão como insumo estratégico para a construção do protótipo, assegurando maior consistência, eficiência e alinhamento com as necessidades dos usuários nas etapas subsequentes do Design Sprint.
...
|  1.8   | 03/04/2026 | Adicionando hyperlinks [#37](https://github.com/UnBArqDsw2026-1-Turma02/2026.1-T02-G7_CaronaAmigaFCTE_Entrega_01/issues/37)                                                                 | [João Marcos Moraes de Andrade](https://github.com/JJOAOMARCOSS)            | [Ana Victória Guedes da Costa](https://github.com/navicg)       | Artefato revisado.  |