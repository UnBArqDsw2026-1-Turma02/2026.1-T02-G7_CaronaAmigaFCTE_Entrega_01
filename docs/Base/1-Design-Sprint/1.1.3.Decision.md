...
[Wanjo Christopher Paraizo Escobar](https://github.com/wChrstphr), 
2026)
</p></font>
...
| :----------------------------------------------------------------: | :-----------------------: |
| O rich picture representa o sistema de forma clara e compreensível, mesmo sem explicação adicional? | - |
| Os elementos visuais (ícones, setas, textos) estão organizados de forma coerente e sem poluição visual? | - |
| O diagrama consegue transmitir tanto o problema quanto a solução proposta? | - |
| Os problemas apresentados (ônibus atrasados, horários incompatíveis, contratempos) refletem a realidade dos estudantes da FCTE? | - |
| O fluxo geral da solução (do problema até a realização da carona) está lógico e fácil de acompanhar? | - |
...
[Link da gravação](https://link-da-gravacao-aqui)
...
|                              Pergunta                              |                      Resposta do(s) Usuário(s)                      |
| :----------------------------------------------------------------: | :----------------------------------------------------------------: |
| O fluxo apresentado é coerente com o funcionamento esperado de vocês do web app que irá ser desenvolvido? | Sim. Os participantes confirmaram que o fluxo apresentado está visível, compreensível e alinhado com o funcionamento esperado do sistema. |
| A jornada do usuário é contínua ou parece quebrada em algum momento? | A jornada foi considerada contínua, especialmente por estar dividida em duas perspectivas (passageiro e motorista), o que facilita o entendimento completo do fluxo. |
| Ao final, fica claro que o objetivo do usuário foi atingido sem dúvidas? | Sim. Foi possível compreender que o objetivo final do usuário é alcançado ao término da jornada apresentada nos storyboards. |
| A proposta do aplicativo (Carona Amiga FCTE) ficou compreensível apenas com o storyboard? | Sim. Os storyboards foram considerados suficientes para transmitir a proposta do aplicativo, evidenciando sua funcionalidade e contexto de uso. |
